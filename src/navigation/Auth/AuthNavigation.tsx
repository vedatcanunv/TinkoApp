...
import {AuthStackParamList} from './AuthNavigation.type';
...
const LoginScreenWrapper = ({navigation}: any) => {
  ...
  return <LoginScreen onLogin={handleLogin} onSignUpPress={handleSignUpPress} />;
};
...
const SignUpScreenWrapper = ({navigation}: any) => {
  ...
  return <SignUpScreen onSignUp={handleSignUp} onLoginPress={handleLoginPress} />;
};
