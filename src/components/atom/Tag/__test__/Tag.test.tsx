...
describe('Tag Component', () => {
  ...
  it('renders with different variants', () => {
    const {toJSON: primary} = render(<Tag label="Primary" variant="primary" />);
    const {toJSON: secondary} = render(<Tag label="Secondary" variant="secondary" />);
    const {toJSON: outline} = render(<Tag label="Outline" variant="outline" />);
  ...
  it('calls onPress when pressed', () => {
    ...
    const {getByText} = render(<Tag label="Clickable Tag" onPress={onPressMock} />);
