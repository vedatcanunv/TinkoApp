...
describe('MediaActionButtons Component', () => {
  it('renders correctly', () => {
    const {toJSON} = render(
      <MediaActionButtons onAddToWatchlist={jest.fn()} onMarkAsWatched={jest.fn()} />
    );
  ...
  it('calls onAddToWatchlist when watch list button is pressed', () => {
    ...
    const {getByTestId} = render(
      <MediaActionButtons onAddToWatchlist={onAddToWatchlistMock} onMarkAsWatched={jest.fn()} />
    );
  ...
  it('calls onMarkAsWatched when watched button is pressed', () => {
    ...
    const {getByTestId} = render(
      <MediaActionButtons onAddToWatchlist={jest.fn()} onMarkAsWatched={onMarkAsWatchedMock} />
    );
